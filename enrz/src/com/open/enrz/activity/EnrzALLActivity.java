...
import com.open.enrz.adapter.AllClassAdapter;
import com.open.enrz.bean.AllBean;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class EnrzALLActivity extends CommonFragmentActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_enrz_all);
		init();
	}
	...
	protected void initValue() {
		...
		try {
			...
			for (ActivityInfo info : activities) {
				if (!EnrzALLActivity.class.getName().equals(info.name)) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (bean != null && !EnrzALLActivity.class.getName().equals(bean.getClassName())) {
