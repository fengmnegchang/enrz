 ...
 *****************************************************************************************************************************************************************************
 */
public class MThumbCatePageListFragmentActivity extends CommonFragmentActivity {
	...
	protected void initValue() {
		...
		if (getIntent().getStringExtra("URL") != null) {
			...
			url = UrlUtils.ENRZ_CATEGORY;
		}
		 
		Fragment fragment = MThumbPullListFragment.newInstance(url, true);
		getSupportFragmentManager().beginTransaction().replace(R.id.layout_indicator, fragment).commit();
	}

	public static void startMThumbCatePageListFragmentActivity(Context context,  String url) {
		Intent intent = new Intent();
		intent.putExtra("URL", url);
		intent.setClass(context, MThumbCatePageListFragmentActivity.class);
