...
import com.open.enrz.weak.WeakTabActivityReferenceHandler;
...
public class BaseTabActivity<T> extends TabActivity implements OnClickListener,  CallEarliest<T>, Callback<T>, Callable<T>, ProgressCallable<T>,
Response.Listener<JSONObject>, Response.ErrorListener {
	public static final String SHARE_NAME = "NEWS_INFO_PROJECT";
	public static final String IS_FIRST_IN = "is_first_in";
	public SharedPreferences mSharedPreferences;
	private ImageLoadingListener animateFirstListener = new AnimateFirstDisplayListener();
	public WeakTabActivityReferenceHandler weakReferenceHandler;
