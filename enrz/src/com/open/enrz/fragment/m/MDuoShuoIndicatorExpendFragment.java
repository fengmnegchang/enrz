 ...
 *****************************************************************************************************************************************************************************
 */
public class MDuoShuoIndicatorExpendFragment extends GnSubIndicatorFragment {

	public static MDuoShuoIndicatorExpendFragment newInstance(  String url, boolean isVisibleToUser) {
		MDuoShuoIndicatorExpendFragment fragment = new MDuoShuoIndicatorExpendFragment();
	...
	public void onCallback(GnSubJson result) {
		...
		for (GnSubBean bean : result.getList()) {
			...
			if ("最新".equals(bean.getTarget())) {
				fragment = MDuoShuoPostsExpendListFragment.newInstance(bean.getHref(), true);
			} else {
				fragment = MDuoShuoPostsExpendListFragment.newInstance(bean.getHref(), false);
			}
