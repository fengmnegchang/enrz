 ...
 *****************************************************************************************************************************************************************************
 */
public class MobileGlobalNavMPullAdapter extends CommonAdapter<ThumbnailBean>{

	public MobileGlobalNavMPullAdapter(Context mContext, List<ThumbnailBean> list) {
		super(mContext, list);
	}
	@Override
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_mobile_global_nav_m_pull, parent, false);
