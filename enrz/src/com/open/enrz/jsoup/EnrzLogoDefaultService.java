...
public class EnrzLogoDefaultService extends CommonService {
	public static final String TAG = EnrzLogoDefaultService.class.getSimpleName();
	...
	public static List<ThumbnailBean> parseListThumbnail(String href,int pagerno) {
		...
		try {
			if(pagerno>1){
				// http://enrz.com/fhm/2016/page/2
				href = href+"fhm/2016/page/"+pagerno;
			}
