...
import com.open.enrz.fragment.PicGalleryFragment;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class PicGalleryFragmentActivity extends CommonFragmentActivity {
	...
	protected void initValue() {
		...
		Fragment fragment = PicGalleryFragment.newInstance(url, true);
		getSupportFragmentManager().beginTransaction().replace(R.id.layout_plistview, fragment).commit();
	}

	public static void startPicGalleryFragmentActivity(Context context, String url) {
		Intent intent = new Intent();
		intent.putExtra("URL", url);
		intent.setClass(context, PicGalleryFragmentActivity.class);
