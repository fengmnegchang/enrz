 ...
 ***************************************************************************************************************************************************************************** 
 */
public class PicExpendExpandableListViewHeadFragment extends BaseV4Fragment<GnSubJson, PicExpendExpandableListViewHeadFragment> {
	...
	public static PicExpendExpandableListViewHeadFragment newInstance(String url, boolean isVisibleToUser) {
		PicExpendExpandableListViewHeadFragment fragment = new PicExpendExpandableListViewHeadFragment();
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		headview = LayoutInflater.from(getActivity()).inflate(R.layout.layout_pic_headview_fragment, null);
		return view;
	}
	...
	public void initValues() {
		...
		PicHeadPagerFragment fragment = PicHeadPagerFragment.newInstance(url, true);
