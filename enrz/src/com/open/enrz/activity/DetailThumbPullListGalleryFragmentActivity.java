...
import com.open.enrz.fragment.DetailThumbPullListViewGalleryFragment;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class DetailThumbPullListGalleryFragmentActivity extends CommonFragmentActivity {
	...
	protected void initValue() {
		...
		Fragment fragment = DetailThumbPullListViewGalleryFragment.newInstance(url, true);
		getSupportFragmentManager().beginTransaction().replace(R.id.layout_plistview, fragment).commit();
	}

	public static void startDetailThumbPullListGalleryFragmentActivity(Context context, String url) {
		Intent intent = new Intent();
		intent.putExtra("URL", url);
		intent.setClass(context, DetailThumbPullListGalleryFragmentActivity.class);
