...
import com.open.enrz.fragment.m.MThumbCateExpandListFragment;
import com.open.enrz.fragment.m.MThumbCateHeadExpandListFragment;
 ...
 *****************************************************************************************************************************************************************************
 */
public class MThumbCateHeadExpandListFragmentActivity extends CommonFragmentActivity {
	...
	protected void initValue() {
		...
		Fragment fragment = MThumbCateHeadExpandListFragment.newInstance(url, true);
		getSupportFragmentManager().beginTransaction().replace(R.id.layout_indicator, fragment).commit();
	}

	public static void startMThumbCateHeadExpandListFragmentActivity(Context context,  String url) {
		Intent intent = new Intent();
		intent.putExtra("URL", url);
		intent.setClass(context, MThumbCateHeadExpandListFragmentActivity.class);
